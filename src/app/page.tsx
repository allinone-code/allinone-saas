...
import BriefingDecisionTab from "@/components/tabs/BriefingDecisionTab";
import ResearchersTab from "@/components/tabs/ResearchersTab";
  ...
  return (
    <div className="min-h-screen bg-[#080C14] bg-tactical-grid text-slate-100 flex flex-col font-sans selection:bg-indigo-500/30">
      ...
      <main className="flex-1 p-5 sm:p-6 max-w-[1700px] w-full mx-auto space-y-5">
        ...
        {/* ========================================================================= */}
        {activeTab === "PROBLEMS" && (
          <ProblemsTab filteredOrders={filteredOrders} onSelectOrder={setSelectedOrder} />
        )}
